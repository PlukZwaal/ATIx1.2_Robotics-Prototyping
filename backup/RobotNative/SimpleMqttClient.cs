...
var mqttWrapper = new SimpleMqttClient(new()
        {
            Host = "ed196fca52084d6080b492dd74d8d241.s1.eu.hivemq.cloud", // maak eventueel een account aan bij hivemq als dit problemen geeft.
            Port = 8883,
            ...
            UserName = "hivemq.webclient.1732698079557",
            Password = "w*1O78I<b0#QaU$lFuoV"
        });
